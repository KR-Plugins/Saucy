...
namespace Saucy
{
    public class Inputs : IDisposable
    {
        ...
        public unsafe Inputs()
        {
            ...
            var kbprocAddress = Svc.SigScanner.ScanText("48 89 5C 24 ?? 55 56 57 41 56 41 57 48 8D 6C 24 ?? 48 81 EC ?? ?? ?? ?? 48 8B 05 ?? ?? ?? ?? 48 33 C4 48 89 45 ?? 4D 8B F9"); // note: look for callers of GetKeyboardState
